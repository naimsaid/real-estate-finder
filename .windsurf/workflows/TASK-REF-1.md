...
- Clé : REF-1
- Titre : realiser les test avec karma et jasmin 
- Priorité : Medium
- Branche à créer : feature/ref-1

## Description fonctionnelle

 realiser les test avec karma et jasmin 
...
4. Créer ou utiliser la branche feature/ref-1.
5. Vérifier que la branche courante est bien feature/ref-1.
...
- Branche utilisée : feature/ref-1
