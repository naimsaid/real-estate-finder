...
- Clé : REF-2
- Titre : implémenter l'onglet quartiers
- Priorité : Medium
- Branche à créer : feature/ref-2

## Description fonctionnelle

Value : implémenter l'onglet quartiers
...
4. Créer ou utiliser la branche feature/ref-2.
5. Vérifier que la branche courante est bien feature/ref-2.
...
- Branche utilisée : feature/ref-2
